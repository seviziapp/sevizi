...
const styles = StyleSheet.create({
  ...
  avatar: { width: 52, height: 52, borderRadius: radii.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.vertSoft, alignItems: 'center', justifyContent: 'center' },
