  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <CalendarDays size={20} color={colors.encre} />, label: 'Mes rendez-vous', onPress: () => router.push('/client/appointments') },
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: colors.vert, alignItems: 'center', justifyContent: 'center', marginBottom: spacing.sm, ...shadow.glow },
  ...
  itemBorder: { borderBottomWidth: 1, borderBottomColor: 'rgba(6,41,31,0.05)' },
